...
<div class="pantalla_lglm">
    <div class="timeline">
        <div class="circle" onmouseover="showInfo('info1')">1</div>
        <div class="circle" onmouseover="showInfo('info2')">2</div>
        <div class="circle" onmouseover="showInfo('info3')">3</div>
        <div class="circle" onmouseover="showInfo('info4')">4</div>
        <div class="circle" onmouseover="showInfo('info5')">5</div>
        <div class="circle" onmouseover="showInfo('info6')">6</div>


        <!-- Añade más círculos según sea necesario -->
    </div>
    <div class="large-box" id="largeBox">
...
function showInfo(infoId) {
    ...
    const info = {
        'info1': `
        <div class="EvoInfo">
            <h2 class="EvoTitle">HACE MÁS DE 500 MILLONES DE AÑOS</h2>
        ...
        'info2': `
        <div class="EvoInfo">
            <h2 class="EvoTitle">HACE 300 MILLONES DE AÑOS</h2>
        ...
        'info3': `
        <div class="EvoInfo">
            <h2 class="EvoTitle">HACE 140 MILLONES DE AÑOS</h2>
        ...
        'info4': `
            <div class="EvoInfo">
                <h2 class="EvoTitle">HACE 95 MILLONES DE AÑOS</h2>
        ...
        'info5': `
            <div class="EvoInfo">
                <h2 class="EvoTitle">HACE 50-30 MILLONES DE AÑOS</h2>
        ...
        'info6': `
            <div class="EvoInfo">
                <h2 class="EvoTitle">HOY EN DÍA</h2>
