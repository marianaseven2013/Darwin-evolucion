...
DOM_evolucion19.innerHTML = `
    ...
    <div class="menu-zarsu">
        ...
        <div class="btn-reg">
            <a class="regresar">Regresa al Inicio</a>
        </div>
    </div>
`;

let informacion1 = document.querySelector(".boton1");

informacion1.addEventListener("click",()=>{
    let bloque1 = document.querySelector(".info");
...
let informacion2 = document.querySelector(".boton1");

informacion1.addEventListener("click",()=>{
    let bloque2 = document.querySelector(".info-p");
...
let informacion3 = document.querySelector(".boton2");

informacion3.addEventListener("click",()=>{
    let bloque3 = document.querySelector(".info");
...
let informacion4 = document.querySelector(".boton2");

informacion4.addEventListener("click",()=>{
    let bloque4 = document.querySelector(".info-p");
    ...
    bloque4.innerHTML= `
            <div class="info-p">              
                ...
                <p>El STM se basa en el fenómeno del efecto túnel cuántico, donde una corriente eléctrica fluye entre una punta conductora extremadamente fina y la superficie de una muestra cuando están a una distancia muy corta, sin contacto físico directo</p>
...
let informacion5 = document.querySelector(".boton3");

informacion5.addEventListener("click",()=>{
    let bloque5 = document.querySelector(".info");
...
let informacion6 = document.querySelector(".boton3");

informacion6.addEventListener("click",()=>{
    let bloque6 = document.querySelector(".info-p");
...
let informacion7 = document.querySelector(".boton4");

informacion7.addEventListener("click",()=>{
    let bloque7 = document.querySelector(".info");
...
let informacion8 = document.querySelector(".boton4");

informacion8.addEventListener("click",()=>{
    let bloque8= document.querySelector(".info-p");
...
let informacion9 = document.querySelector(".boton5");

informacion9.addEventListener("click",()=>{
    let bloque9 = document.querySelector(".info");
...
let informacion10 = document.querySelector(".boton5");

informacion10.addEventListener("click",()=>{
    let bloque10= document.querySelector(".info-p");
...
let informacion12 = document.querySelector(".btn-reg");

informacion12.addEventListener("click",()=>{
    let bloque12= document.querySelector(".seccion");
